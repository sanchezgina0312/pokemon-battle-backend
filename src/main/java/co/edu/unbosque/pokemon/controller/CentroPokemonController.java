 ...
 * <p>
 * Proporciona endpoints para interactuar con los servicios de salud y
 * recuperación de los Pokémon en el sistema. Permite peticiones CORS desde los
 * orígenes locales en los puertos 8080 y 8081.
 * </p>
 * 
...
public class CentroPokemonController {
	...
	/**
	 * Servicio que contiene la lógica de negocio para las operaciones del Centro
	 * Pokémon.
	 */
	@Autowired
	...
	/**
	 * Restaura la salud de un Pokémon específico en el sistema utilizando su
	 * identificador.
	 * <p>
	 * El método evalúa el resultado de la operación realizada por el servicio: Si
	 * retorna {@code 0}, la curación fue exitosa y se responde con un estado HTTP
	 * 202 (Accepted). Cualquier otro valor indica que el Pokémon no fue hallado,
	 * respondiendo un estado HTTP 404 (Not Found).
	 * </p>
	 * 
	 * @param idPokemon El identificador único del Pokémon que se desea curar.
	 * @return Un {@link ResponseEntity} con el mensaje "Curado" y estado
	 *         {@link HttpStatus#ACCEPTED} (202) si el proceso fue exitoso; de lo
	 *         contrario, un mensaje "No encontrado" junto con el estado
	 *         {@link HttpStatus#NOT_FOUND} (404).
	 */
	@PostMapping("/curar")
