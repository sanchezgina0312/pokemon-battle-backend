...
public class PokemonHTTPRequestHandler {
	 ...
	 */
	public static List<String> extraerCuatroPrimerosAtaques(
			List<co.edu.unbosque.pokemon.dto.AtaquePokemonDTO> listaAtaques) {
	...
	/**
	 * Obtiene los ataques disponibles desde la PokeAPI. Preservado de main_copy —
	 * usado por AtaqueService.obtenerCatalogoAtaques().
	 *
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 10; i++) {
			...
			for (TipoPokemonDTO t : p.getListaTipos()) {
				System.out.println(
						" -> Link del Icono " + t.getInformacionTipo().getNombreTipo() + ": " + obtenerUrlIconoTipo(t));
			}
